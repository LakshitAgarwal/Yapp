              ...
              <label className="input validator relative w-full">
                ...
                <input
                  ...
                  onChange={
                    (e) =>
                      setFormData({
                        ...formData, // 1️⃣ Copy everything from the existing state
                        fullName: e.target.value, // 2️⃣ Update the fullName field only
                      })
                    /**
                     * ...formData → copies all the previous fields
                     * fullName: e.target.value → overrides just the fullName field
                     */
                  }
                />
              </label>
